---
title: "Important Factors in Predicting a Stroke"
author: "Group 10"
output: 
...
The two variables were are most interested in are not very balanced. On the left is a histogram for hypertension, and on the right is one for heart disease.As mentioned before, only 9.75% of the patients having hypertension and 5.40% of them having heart disease
...
This is a visualization of the correlation plot, which confirms that no variables appear to be highly correlated with one another. The dark blue diagonal circles are just the variables correlated with themselves.
