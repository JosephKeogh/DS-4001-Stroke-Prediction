...
# Data Cleaning Specifically for Decision Tree
...
str(stroke)
stroke <- stroke[-c(1, 2, 3, 7, 9, 10, 11)]

stroke <- lapply(stroke, function(x) as.factor(x))
...
```{r}
mean(as.numeric(stroke$stroke))-1
