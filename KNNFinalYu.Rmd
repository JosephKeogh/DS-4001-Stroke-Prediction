...
LogLoss(as.numeric(prob_stroke$`1`), as.numeric(test_stroke$stroke)) # 2.820455
...
plot(stroke_perf, colorize = TRUE) + abline(a=0,b=1)
stroke_perf_AUC <- performance(pred_stroke, "auc")
print(stroke_perf_AUC@y.values) # AUC 0.7771214
